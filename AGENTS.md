...
`data-liberation-agent` extracts content from closed web platforms (Wix, Squarespace, Webflow, Shopify, GoDaddy Websites & Marketing) and produces WordPress-compatible WXR files. All five platform adapters are implemented.
