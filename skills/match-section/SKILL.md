...
- `outputDir` (e.g. `~/data-liberation/example.com`), `studioSitePath` (e.g. `~/Studio/example-com`), `themeSlug`, the page `slug` + `sourceUrl`, and the **section index** `i` within that page.
