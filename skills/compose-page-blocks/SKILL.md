...
- **Hallucinate copy.** Every visible word in your output must come from the source HTML — verbatim or near-verbatim. Headings, button labels, paragraph text, alt text. If you can't find supporting text in the source, omit the section. Do not "fill in plausible words."
