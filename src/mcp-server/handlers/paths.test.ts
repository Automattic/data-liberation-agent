...
describe('pathsHandler', () => {
  ...
  beforeEach(() => { prev = process.env.STUDIO_SITES_DIR; delete process.env.STUDIO_SITES_DIR; delete process.env.DLA_OUTPUT_DIR; });
  afterEach(() => { if (prev === undefined) delete process.env.STUDIO_SITES_DIR; else process.env.STUDIO_SITES_DIR = prev; });
